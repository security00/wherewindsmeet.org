...
export const martialArtPaths: MartialArtPath[] = [
  ...
  },
  {
    id: "bamboocut-kite",
    name: "Bamboocut - Kite",
    focus: "Duong gang Version 2.0 gan voi Mohist Hill.",
    flavor: "Mua trong shop Mohist Hill ngay ca khi chua nhap mon. Khac bo uong ruou 3/9.",
    relatedWeapons: ["Gauntlets"],
  },
  {
    id: "bamboocut-draught",
    name: "Bamboocut - Draught",
    focus: "Drunken Fist melee DPS dung Binge Points de vao Inebriate.",
    flavor: "Global 3/9/2026. Skystrike Gauntlets uong ho lo; Riven Twinblades doi gauge day thanh burst tren khong.",
...
export const martialArtWeapons: MartialArtWeapon[] = [
  ...
  },
  {
    ...
    unlockMethods: [
      "Sects → Shop → View other sects → Mohist Hill, ke ca khi chua nhap mon.",
      "Xem trang Gauntlets cho duong shop Version 2.0.",
    ],
  },
  {
    ...
    unlockMethods: [
      "Martial Fellowship ong gia o Gasping Cliff.",
      "Xem trang Drunken Fist cho ca bon diem.",
    ],
  },
  {
    id: "riven-twinblades",
    ...
    unlockMethods: [
      "Noi voi Li Yangui phia bac Northern Vow Ruins (Revisit sau Echoes of Old Battles).",
    ],
  },
];
