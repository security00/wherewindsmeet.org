export { currentWeaponRoster } from "./weaponTierData";
export type { CurrentWeaponId } from "./weaponTierData";
...
export type Weapon = {
  ...
  name: string;
  role: string;
  /** @deprecated Use the versioned evidence matrix in weaponTierData instead. */
  tier?: "S" | "A" | "B";
  description: string;
  officialArt: string;
