...
import FeaturedImagesGallery from "@/app/(en)/guides/cosmetics/FeaturedImagesGallery";
import AppearanceSetsDisplay from "@/app/(en)/guides/cosmetics/AppearanceSetsDisplay";
import OtherAppearancesDisplay from "@/app/(en)/guides/cosmetics/OtherAppearancesDisplay";
import appearanceSets from "@/app/(en)/guides/cosmetics/appearance-sets.vi.json";
import otherAppearances from "@/app/(en)/guides/cosmetics/other-appearances.vi.json";
