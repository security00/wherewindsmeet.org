...
const guideSections = [
  ...
  },
  {
    ...
    slug: "/vn/guides/heavens-threshold-cloudstair",
    label: "Toàn server",
    icon: "☁️",
    color: "text-sky-300",
    size: "medium",
    description: "Cloudtop Ascent Foundation, Mountain Express, Work Merit và cách xử lý khu vực còn khóa.",
  },
  {
    title: "Evershift Labyrinth",
    slug: "/vn/guides/evershift-labyrinth",
    label: "Puzzle",
    icon: "⚙️",
    color: "text-amber-300",
    size: "medium",
    description: "Cần gạt, cú nhảy đúng lúc, chim vàng và sửa lỗi objective.",
  },
  {
    title: "Mở khóa Hidden Mountain",
    slug: "/vn/guides/hidden-mountain",
    label: "Version 2.1",
    icon: "🏔️",
    color: "text-violet-300",
    size: "medium",
    description: "Tuyến mở khóa, trailer chính thức, Cloudstair, water rail và thư nhà phát triển mới.",
  },
  {
    title: "Mã tạo nhân vật",
    slug: "/vn/guides/character-creation-codes",
    label: "Text + QR",
    icon: "🎭",
    color: "text-rose-300",
    size: "medium",
    description: "Nhập preset khuôn mặt bằng ảnh từng bước và xử lý lỗi mã.",
  },
  {
    title: "Commerce Coins",
    slug: "/vn/guides/commerce-coins",
    label: "Giao dịch",
    icon: "🪙",
    color: "text-amber-300",
    size: "medium",
    description: "Vòng giao thương an toàn hơn, công dụng và video hướng dẫn.",
  },
  {
  ...
  {
    title: "Drunken Fist",
    slug: "/vn/guides/drunken-fist",
    label: "Version 2.1.3",
    icon: "🍶",
    color: "text-amber-300",
    size: "medium",
    description: "Skystrike Gauntlets, Riven Twinblades và bốn Inner Way Draught ngày 3/9.",
  },
  {
    title: "Reflection Temple",
    slug: "/vn/guides/reflection-temple",
    label: "Sự kiện",
    icon: "🕯️",
    color: "text-violet-300",
    size: "medium",
    description: "Sân khấu Ghost Month: teleport sự kiện, kiêng kỵ, lễ vật, hết 27/9.",
  },
  {
    title: "Mystic Arts",
    slug: "/vn/guides/mystic-arts",
    label: "Hệ thống",
    icon: "✨",
    color: "text-sky-300",
    size: "small",
    description: "Trang bị, mở slot, và các mystic hay tìm nhất.",
  },
  {
    title: "Cách bay",
    slug: "/vn/guides/how-to-fly",
    label: "Di chuyển",
    icon: "🪶",
    color: "text-cyan-300",
    size: "small",
    description: "Afterglow, Meteor Flight, Afterglow Pendant ở Qinghe Exploration 4.",
  },
  {
    title: "Inner Ways",
    slug: "/vn/guides/inner-ways",
    label: "Bị động",
    icon: "📿",
    color: "text-emerald-300",
    size: "small",
    description: "Bốn slot plus Eonpour, Skyspeak, Mistwing, Volutefit.",
  },
  {
    title: "Gauntlets",
    slug: "/vn/guides/gauntlets",
    label: "Version 2.0",
    icon: "🥊",
    color: "text-orange-300",
    size: "small",
    description: "Bamboocut - Kite trong shop Mohist Hill, khác Drunken Fist.",
  },
  {
    title: "Mohist Hill",
    slug: "/vn/guides/mohist-hill",
    label: "Môn phái",
    icon: "⚙️",
    color: "text-slate-300",
    size: "small",
    description: "Môn xây dựng, shop không nhập môn, hub Cloudstair.",
  },
  {
    title: "Divinecraft Dungeons",
    slug: "/vn/guides/divinecraft-dungeons",
    label: "Thám hiểm",
    icon: "🏯",
    color: "text-amber-200",
    size: "medium",
    description: "Hang đố, cụm Qinghe, Phasecycle và Zenithstride.",
  },
  {
    title: "Phasecycle",
    slug: "/vn/guides/phasecycle",
    label: "Dungeon",
    icon: "🔄",
    color: "text-cyan-200",
    size: "small",
    description: "Divinecraft tây bắc Hidden Mountain.",
  },
  {
    title: "Zenithstride",
    slug: "/vn/guides/zenithstride",
    label: "Dungeon",
    icon: "☁️",
    color: "text-sky-200",
    size: "small",
    description: "Divinecraft Heaven's Threshold sau Cloudstair.",
  },
  {
    title: "Ephemeral Glory",
    slug: "/vn/guides/ephemeral-glory",
    label: "Đố",
    icon: "🐦",
    color: "text-teal-300",
    size: "medium",
    description: "Đố chim cơ quan với Celestial Seize.",
  },
  {
    title: "Mirkvale",
    slug: "/vn/guides/mirkvale",
    label: "Campaign",
    icon: "🔔",
    color: "text-rose-300",
    size: "small",
    description: "Phía tây Heaven's Threshold, boss Bell Toller.",
  },
  {
