...
const guideSections = [
  ...
  },
  {
    ...
    slug: "/de/guides/heavens-threshold-cloudstair",
    label: "Server-Freischaltung",
    icon: "☁️",
    color: "text-sky-300",
    size: "medium",
    description: "Cloudtop Ascent, Mountain Express, Work Merit, Serverfortschritt und Sperrfehler.",
  },
  {
    title: "Evershift Labyrinth",
    slug: "/de/guides/evershift-labyrinth",
    label: "Rätsel",
    icon: "⚙️",
    color: "text-amber-300",
    size: "medium",
    description: "Drehblock-Lösung mit Hebel, Sprung, goldenem Vogel und Fehlerhilfe.",
  },
  {
    title: "Hidden Mountain freischalten",
    slug: "/de/guides/hidden-mountain",
    label: "Version 2.1",
    icon: "🏔️",
    color: "text-violet-300",
    size: "medium",
    description: "Freischaltung, offizieller Trailer, Cloudstair, Wasserbahnen und neuer Entwicklerbrief.",
  },
  {
    title: "Character-Creation-Codes",
    slug: "/de/guides/character-creation-codes",
    label: "Text + QR",
    icon: "🎭",
    color: "text-rose-300",
    size: "medium",
    description: "Gesichts-Presets mit bebilderten Schritten importieren und Fehler beheben.",
  },
  {
    title: "Commerce Coins",
    slug: "/de/guides/commerce-coins",
    label: "Handel",
    icon: "🪙",
    color: "text-amber-300",
    size: "medium",
    description: "Sicherer Handelsablauf, Verwendungen, Live-Markt-Checks und Video.",
  },
  {
  ...
  },
  {
    ...
    slug: "/de/guides/who-is-destined-to-face-the-purple-star-catastrophe",
    label: "Quiz & Lore",
    icon: "🟣",
    color: "text-purple-300",
    size: "small",
  ...
  {
    title: "Drunken Fist",
    slug: "/de/guides/drunken-fist",
    label: "Version 2.1.3",
    icon: "🍶",
    color: "text-amber-300",
    size: "medium",
    description: "Skystrike Gauntlets, Riven Twinblades und vier Draught-Inner-Ways vom 3. September.",
  },
  {
    title: "Reflection Temple",
    slug: "/de/guides/reflection-temple",
    label: "Live-Event",
    icon: "🕯️",
    color: "text-violet-300",
    size: "medium",
    description: "Ghost-Month-Bühne: Event-Teleport, Tabus, Opfergaben, Ende 27. September.",
  },
  {
    title: "Mystic Arts",
    slug: "/de/guides/mystic-arts",
    label: "Systeme",
    icon: "✨",
    color: "text-sky-300",
    size: "small",
    description: "Ausrüsten, Slots und die meistgesuchten Freischaltungen.",
  },
  {
    title: "Fliegen",
    slug: "/de/guides/how-to-fly",
    label: "Bewegung",
    icon: "🪶",
    color: "text-cyan-300",
    size: "small",
    description: "Afterglow, Meteor Flight und Afterglow Pendant auf Qinghe Exploration 4.",
  },
  {
    title: "Inner Ways",
    slug: "/de/guides/inner-ways",
    label: "Passive",
    icon: "📿",
    color: "text-emerald-300",
    size: "small",
    description: "Vier Slots plus Eonpour, Skyspeak, Mistwing und Volutefit.",
  },
  {
    title: "Gauntlets",
    slug: "/de/guides/gauntlets",
    label: "Version 2.0",
    icon: "🥊",
    color: "text-orange-300",
    size: "small",
    description: "Bamboocut - Kite im Mohist-Hill-Shop, getrennt von Drunken Fist.",
  },
  {
    title: "Mohist Hill",
    slug: "/de/guides/mohist-hill",
    label: "Sekte",
    icon: "⚙️",
    color: "text-slate-300",
    size: "small",
    description: "Bau-Sekte, Shop ohne Beitritt, Cloudstair-Hub.",
  },
  {
    title: "Divinecraft Dungeons",
    slug: "/de/guides/divinecraft-dungeons",
    label: "Erkundung",
    icon: "🏯",
    color: "text-amber-200",
    size: "medium",
    description: "Puzzle-Kavernen, Qinghe-Cluster, Phasecycle und Zenithstride.",
  },
  {
    title: "Phasecycle",
    slug: "/de/guides/phasecycle",
    label: "Dungeon",
    icon: "🔄",
    color: "text-cyan-200",
    size: "small",
    description: "Divinecraft im Nordwesten von Hidden Mountain.",
  },
  {
    title: "Zenithstride",
    slug: "/de/guides/zenithstride",
    label: "Dungeon",
    icon: "☁️",
    color: "text-sky-200",
    size: "small",
    description: "Heaven’s-Threshold-Divinecraft nach Cloudstair.",
  },
  {
    title: "Ephemeral Glory",
    slug: "/de/guides/ephemeral-glory",
    label: "Puzzle",
    icon: "🐦",
    color: "text-teal-300",
    size: "medium",
    description: "Mechanische Vogelrätsel mit Celestial Seize.",
  },
  {
    title: "Mirkvale",
    slug: "/de/guides/mirkvale",
    label: "Kampagne",
    icon: "🔔",
    color: "text-rose-300",
    size: "small",
    description: "Westlich von Heaven’s Threshold, Boss Bell Toller.",
  },
  {
    title: "Endgame-Guide",
    ...
    <div className="min-h-screen bg-ink-wash pb-20">
      <section className="relative h-[40vh] min-h-[400px] w-full overflow-hidden">
        ...
        <div className="relative z-30 flex h-full flex-col justify-center px-6 sm:px-12 lg:w-2/3">
          ...
          >
            🎯 Trend-Quiz: Murong Yuan Adoptivvater (schnelle Antwort)
          </Link>
          <Link
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 relative z-20 pb-8">
