...
const images = {
  hero: {
    src: "/guides/imperial-decree/imperial-decree-review-memorials.png",
    alt: "Imperial Decree memorial review screen in Where Winds Meet",
  },
  map: {
    src: "/guides/imperial-decree/imperial-decree-map-location.png",
    alt: "Imperial Decree map location in Kaifeng Imperial Palace",
  },
  location: {
    src: "/guides/imperial-decree/imperial-decree-locations-overview.png",
    alt: "Imperial Decree locations overview in Where Winds Meet",
  },
  talkToQuChunqiu: {
    src: "/guides/imperial-decree/imperial-decree-talk-to-qu-chunqiu.png",
    alt: "Talk to Qu Chunqiu to start Imperial Decree in Where Winds Meet",
  },
  unrollScroll: {
    src: "/guides/imperial-decree/imperial-decree-unroll-scroll-and-write.png",
    alt: "Unroll the Imperial Decree scroll and write remarks",
  },
  financeVolume: {
    src: "/guides/imperial-decree/imperial-decree-finance-volume.png",
    alt: "Imperial Decree Finance volume prompts",
  },
  overallGrade: {
    src: "/guides/imperial-decree/imperial-decree-overall-grade.png",
    alt: "Imperial Decree overall grade screen",
  },
  palaceChronicle: {
    src: "/guides/imperial-decree/imperial-decree-palace-chronicle-event.png",
    alt: "Palace Chronicle event tied to Imperial Decree",
  },
  rearGardenSentient: {
    src: "/guides/imperial-decree/imperial-decree-rear-garden-sentient-being.png",
    alt: "Rear Garden Imperial Decree Sentient Being entry",
  },
  sideQuestCard: {
    src: "/guides/imperial-decree/imperial-decree-side-quest-card.png",
    alt: "Imperial Decree side quest card in Where Winds Meet",
  },
};
const heroImageUrl = `${baseUrl}${images.hero.src}`;
