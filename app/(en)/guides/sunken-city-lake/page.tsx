  ...
  return (
    <article className="space-y-10 bg-ink-wash min-h-screen pb-20">
      ...
      <section className="rounded-3xl border border-cyan-400/25 bg-cyan-500/10 p-6 shadow-lg shadow-slate-950/40">
        <h2 className="text-2xl font-bold text-cyan-50">Visual route: Painter → Dreamtouch Brush → Underwater Entrance</h2>
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-4">
          <div className="relative rounded-2xl border border-cyan-300/30 bg-slate-950/75 p-4">
            ...
            <h3 className="text-base font-semibold text-slate-50">Painter</h3>
            <p className="mt-2 text-sm leading-6 text-slate-300">Speak near the large rock after To Friends, to the End progresses.</p>
          </div>
          <div className="relative rounded-2xl border border-cyan-300/30 bg-slate-950/75 p-4">
            ...
            <h3 className="text-base font-semibold text-slate-50">Dreamtouch Brush</h3>
            <p className="mt-2 text-sm leading-6 text-slate-300">Pick up the brush from the waypoint near the ruins.</p>
          </div>
          <div className="relative rounded-2xl border border-cyan-300/30 bg-slate-950/75 p-4">
            ...
            <h3 className="text-base font-semibold text-slate-50">Dive entrance</h3>
            <p className="mt-2 text-sm leading-6 text-slate-300">Use the water waypoint, save stamina, then dive.</p>
          </div>
          <div className="relative rounded-2xl border border-cyan-300/30 bg-slate-950/75 p-4">
            ...
            <h3 className="text-base font-semibold text-slate-50">Lan Ao chase</h3>
            <p className="mt-2 text-sm leading-6 text-slate-300">Use Wind Sense and continue the city sequence.</p>
          </div>
        </div>
      </section>
