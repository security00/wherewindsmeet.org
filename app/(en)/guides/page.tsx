...
const guideSections = [
  ...
  },
  {
    ...
    slug: "/guides/heavens-threshold-cloudstair",
    label: "Server Unlock",
    icon: "☁️",
    color: "text-sky-300",
    size: "medium",
    description: "Cloudtop Ascent Foundation, Mountain Express, Work Merit, server progress, and locked-area fixes.",
  },
  {
    title: "Evershift Labyrinth",
    slug: "/guides/evershift-labyrinth",
    label: "Puzzle",
    icon: "⚙️",
    color: "text-amber-300",
    size: "medium",
    description: "Rotating-block solution: lever, timed jump, golden bird, objective confirmation, and blocker fixes.",
  },
  {
    title: "Hidden Mountain Unlock Guide",
    slug: "/guides/hidden-mountain",
    label: "Version 2.1",
    icon: "🏔️",
    color: "text-violet-300",
    size: "medium",
    description: "Unlock route, official trailer, region scope, Cloudstair, water rails, and the latest developer-letter changes.",
  },
  {
    title: "Character Creation Codes",
    slug: "/guides/character-creation-codes",
    label: "Text + QR",
    icon: "🎭",
    color: "text-rose-300",
    size: "medium",
    description: "Import face presets with visual menu steps, cosmetic limits, and code troubleshooting.",
  },
  {
    title: "Commerce Coins",
    slug: "/guides/commerce-coins",
    label: "Trade Guide",
    icon: "🪙",
    color: "text-amber-300",
    size: "medium",
    description: "A safer cross-world trading loop, uses, live-market checks, and a video walkthrough.",
  },
  {
    title: "Drunken Fist Unlock",
    slug: "/guides/drunken-fist",
    label: "Version 2.1.3",
    icon: "🍶",
    color: "text-amber-300",
    size: "medium",
    description: "Skystrike Gauntlets, Riven Twinblades, and four Draught Inner Ways from the September 3 path.",
  },
  {
    title: "Reflection Temple",
    slug: "/guides/reflection-temple",
    label: "Live Event",
    icon: "🕯️",
    color: "text-violet-300",
    size: "medium",
    description: "Ghost Month stage: event-page teleport, taboos, offerings, and the September 27 end date.",
  },
  {
    title: "Mystic Arts Unlock List",
    slug: "/guides/mystic-arts",
    label: "Systems",
    icon: "✨",
    color: "text-sky-300",
    size: "medium",
    description: "Equip slots, Talent-track expansions, and the mystic arts players actually search for.",
  },
  {
    title: "How to Fly",
    slug: "/guides/how-to-fly",
    label: "Movement",
    icon: "🪶",
    color: "text-cyan-300",
    size: "small",
    description: "Afterglow quest, Meteor Flight, and the Qinghe Exploration Level 4 Afterglow Pendant.",
  },
  {
    title: "Inner Ways",
    slug: "/guides/inner-ways",
    label: "Passives",
    icon: "📿",
    color: "text-emerald-300",
    size: "small",
    description: "Four-slot rules plus Eonpour, Skyspeak, Mistwing, and Volutefit.",
  },
  {
    title: "Gauntlets (Mohist Shop)",
    slug: "/guides/gauntlets",
    label: "Version 2.0",
    icon: "🥊",
    color: "text-orange-300",
    size: "small",
    description: "Buy Bamboocut - Kite from Mohist Hill without joining. Not the Drunken Fist gauntlets.",
  },
  {
    title: "Mohist Hill",
    slug: "/guides/mohist-hill",
    label: "Sect",
    icon: "⚙️",
    color: "text-slate-300",
    size: "small",
    description: "Construction sect, shop-without-join, and Cloudstair hub inside Hidden Mountain.",
  },
  {
    title: "Divinecraft Dungeons",
    slug: "/guides/divinecraft-dungeons",
    label: "Exploration",
    icon: "🏯",
    color: "text-amber-200",
    size: "medium",
    description: "Puzzle cavern loop, Qinghe cluster, plus Phasecycle and Zenithstride in Hidden Mountain.",
  },
  {
    title: "Phasecycle",
    slug: "/guides/phasecycle",
    label: "Dungeon",
    icon: "🔄",
    color: "text-cyan-200",
    size: "small",
    description: "Northwest Hidden Mountain Divinecraft entrance and chest-loop logic.",
  },
  {
    title: "Zenithstride & Zenithmaze",
    slug: "/guides/zenithstride",
    label: "Dungeon",
    icon: "☁️",
    color: "text-sky-200",
    size: "small",
    description: "Heaven’s Threshold Divinecraft pair after Cloudstair completes.",
  },
  {
    title: "Ephemeral Glory",
    slug: "/guides/ephemeral-glory",
    label: "Puzzle",
    icon: "🐦",
    color: "text-teal-300",
    size: "medium",
    description: "Mechanical bird puzzles: Celestial Seize, chain power, Chen Hour start.",
  },
  {
    title: "Mirkvale",
    slug: "/guides/mirkvale",
    label: "Campaign",
    icon: "🔔",
    color: "text-rose-300",
    size: "small",
    description: "West of Heaven’s Threshold after Cloudstair, with the Bell Toller fight.",
  },
  {
    title: "Clouded Revelation Version 2.1.3",
    ...
    size: "wide",
    description:
      "September 3 Drunken Fist and Reflection Temple on top of the August 20 quest, umbrella, Arena, and Homestead fixes.",
  },
  {
    title: "Active Codes",
    slug: "/guides/codes",
