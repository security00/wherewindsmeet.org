...
export const metadata: Metadata = {
  ...
  description:
    "Datenschutz für den inoffiziellen Where Winds Meet Fan-Hub: welche technischen Daten anfallen, wie eingebettete Videos funktionieren und wie du uns erreichst.",
    ...
    <article className="space-y-8 rounded-3xl border border-slate-800 bg-slate-950/80 p-6 text-sm leading-relaxed text-slate-200 shadow-lg shadow-slate-950/60 sm:p-8">
      <header className="space-y-3">
        ...
        <p className="text-sm text-slate-300">
          Diese Seite erklärt in einfacher Sprache, welche Daten beim Besuch dieses inoffiziellen Where Winds Meet Fan-Hubs anfallen und wie damit umgegangen wird. Fragen jederzeit an{" "}
      ...
      <section className="space-y-2">
        ...
        <p>
          Diese Website ist ein unabhängiger Fan-Hub für Where Winds Meet. Sie wird nicht vom Publisher oder Entwickler betrieben oder unterstützt. Marken und Logos gehören ihren jeweiligen Inhabern. Zweck des Hubs: Guides, Tierlists, Builds, Codes und News an einem Ort bündeln.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>
          Viele Seiten binden YouTube-Videos ein (wenn möglich über <code className="rounded bg-slate-900 px-1 py-0.5 text-xs">youtube-nocookie.com</code>). Sobald du auf Play klickst, kann der Anbieter Cookies setzen, die IP loggen oder dein Nutzungsverhalten mit einem bestehenden Konto verknüpfen. Bitte lies die jeweiligen Datenschutzrichtlinien der Drittanbieter.
        </p>
        <p>
      ...
      <section className="space-y-2">
        ...
        <p>
          ...
          <a href="mailto:support@wherewindsmeet.org" className="text-emerald-300 hover:text-emerald-200">
            support@wherewindsmeet.org
          </a>. Bitte erwähne, welche Seite du besucht hast und ungefähr wann.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>
          Die Inhalte richten sich an allgemeine Gaming-Zielgruppen. Es gibt keine Registrierungen, Käufe oder Kommentare, daher keine bewusste Erfassung sensibler Daten. Falls versehentlich Daten eines Kindes erfasst wurden, informiere uns bitte unter der oben genannten Adresse.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>
          Bei wesentlichen Änderungen (z. B. neue Analytics, neue Features) wird diese Erklärung aktualisiert. Durch die weitere Nutzung nach Veröffentlichung einer aktualisierten Version akzeptierst du die neuen Beschreibungen.
        </p>
      </section>

      <footer className="border-t border-slate-800 pt-4 text-xs text-slate-400 space-y-2">
        <p>Diese Erklärung dient der Transparenz und ersetzt keine Rechte, die dir nach lokalem Recht zustehen.</p>
        <p>
          Zurück zur{" "}
