...
const tierSummaries = [
  {
    ...
    bestFor:
      "Người chơi muốn sức mạnh ổn định, có dư địa học thêm tech nâng cao.",
  },
  {
    tier: "A Tier",
    summary:
  ...
  },
  {
    ...
    bestFor:
      "Người thích off-meta, thể hiện kỹ năng và chọn kèo khắc chế.",
  },
];
...
const tierWeaponExamples = [
  {
    label: "Vũ khí S-Tier",
    description:
      "Những lựa chọn top: mạnh gần như mọi nơi, đặc biệt là PVE late-game và nội dung tổ đội khó.",
    weapons: [
      {
        name: "Nameless Sword",
        note: "Main weapon cực linh hoạt: route mạnh cho story, PVE và PVP giai đoạn đầu.",
      },
      {
        name: "Spear",
      ...
      {
        name: "Mo Blade",
        note: "Bruiser nặng tay: thưởng cho position và nhịp ra chiêu chuẩn.",
      },
      {
        name: "Umbrella",
        note: "Utility phòng thủ + công cụ phản đòn, cân bằng giữa sống sót PVE và tạo đột biến PVP.",
      },
      {
        name: "Dual Blades",
  ...
  },
  {
    ...
    weapons: [
      {
        name: "Fan",
        note: "Thiên về khống chế: thưởng cho spacing, zoning và dùng hồi chiêu thông minh.",
      },
      {
        name: "Hybrid Sword + Spear",
        note: "Kết hợp poke an toàn với finisher tốt khi bạn nắm route.",
      },
      {
  ...
  },
  {
    label: "Vũ khí B-Tier",
    description:
      "Nhiều kèo/đường chơi khá “kén” hoặc phụ thuộc matchup, nhưng rất đáng khi bạn luyện thành thục.",
    weapons: [
      {
      ...
      },
      {
        ...
        note: "Kết hợp lạ: đổi độ ổn định lấy style và yếu tố bất ngờ.",
      },
      {
  ...
  return (
    <article className="space-y-10">
      <section className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-lg shadow-slate-950/60 sm:p-8">
        ...
        <div className="relative">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-200 sm:text-base">
            ...
            đi story, boss PVE endgame, chơi tổ đội, đấu tay đôi PVP, hoặc chạy nhanh. Khi bạn phân vân nên đầu tư vào vũ khí nào tiếp theo, hãy dùng trang
            này làm điểm tựa. Muốn cái nhìn rộng thì xem tier list tổng; muốn chọn vũ khí cụ thể thì đọc tại đây rồi qua trang builds để hoàn thiện setup.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-6 rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-lg shadow-slate-950/60">
        ...
        <p className="text-sm leading-relaxed text-slate-200 sm:text-base">
          Hub có hướng dẫn riêng cho các vũ khí chính. Những trang đó đi sâu cơ chế, combo, synergy chỉ số và tình huống sử dụng – sâu hơn hẳn tier list.
      ...
      <section className="space-y-6 rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-lg shadow-slate-950/60">
        ...
        <p className="text-sm leading-relaxed text-slate-200 sm:text-base">
          Xếp hạng trong tier list phản ánh nhiều yếu tố: sát thương thô, độ cứng cáp, tốc độ “vào form” (đủ mạnh khi có gear/stat), và độ linh hoạt theo
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-700 bg-slate-900/40 p-4">
            ...
            <p className="mt-2 text-xs leading-relaxed text-slate-200">
              S-Tier mạnh trong hầu hết tình huống. A-Tier ổn định nhưng có thể kém ở một số matchup. B-Tier có bản sắc rõ nhưng cần build/đường chơi phù hợp
          ...
          <div className="rounded-xl border border-slate-700 bg-slate-900/40 p-4">
            ...
            <p className="mt-2 text-xs leading-relaxed text-slate-200">
              ...
              vừa phải. Một vũ khí nhìn “trung bình” trên giấy đôi khi lại rất đã khi bạn đầu tư đúng synergy chỉ số.
            </p>
          </div>
          <div className="rounded-xl border border-slate-700 bg-slate-900/40 p-4">
      ...
      <section className="space-y-6 rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-lg shadow-slate-950/60">
        ...
        <p className="text-sm leading-relaxed text-slate-200 sm:text-base">
          Endgame cũng là câu chuyện matchup. “Vũ khí tốt nhất” phụ thuộc vào kẻ địch bạn gặp. Có vũ khí rất mạnh khi đánh quái ngoài map nhưng lại khó chịu
          khi gặp mục tiêu biết block; ngược lại có vũ khí nhìn chung yếu hơn nhưng có một tool giúp “khắc chế” boss cụ thể. Hãy dùng tier list làm điểm
          xuất phát, rồi tùy biến loadout theo thử thách bạn đang gặp.
        </p>
        <div className="mt-4">
          <Link
      ...
      <section className="space-y-6 rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-lg shadow-slate-950/60">
        <h2 className="text-xl font-semibold tracking-tight text-slate-50 sm:text-2xl">
          Kết hợp vũ khí và synergy.
        </h2>
        <p className="text-sm leading-relaxed text-slate-200 sm:text-base">
          Xếp hạng từng vũ khí là quan trọng, nhưng synergy cũng quan trọng không kém. Có cặp vũ khí phối trong cùng build sẽ bổ trợ, khuếch đại điểm mạnh
        ...
        <p className="text-sm leading-relaxed text-slate-200 sm:text-base">
          ...
          hợp và các lựa chọn phối synergy. Nhiều vũ khí chỉ “nở” đúng nghĩa khi bạn build xoay quanh nó. Đừng để tier số cản bạn thử những combo bạn thấy
          hứng thú.
        </p>
        <div className="mt-4">
          <Link
