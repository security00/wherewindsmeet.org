...
const staticEntries: Entry[] = [
  ...
  { path: "/guides/qinchuan", changeFrequency: "weekly", priority: 0.82 },
  { path: "/guides/jiangnan-hangzhou", changeFrequency: "daily", priority: 0.84 },
  { path: "/guides/imperial-decree", changeFrequency: "daily", priority: 0.82 },
  { path: "/guides/sunken-city-lake", changeFrequency: "weekly", priority: 0.8 },
  { path: "/guides/to-friends-to-the-end", changeFrequency: "weekly", priority: 0.8 },
  { path: "/guides/travel-permit", changeFrequency: "weekly", priority: 0.78 },
  { path: "/guides/verdant-flute", changeFrequency: "weekly", priority: 0.78 },
  { path: "/guides/mistveil-city", changeFrequency: "daily", priority: 0.82 },
...
const vnEntries: Entry[] = ([
  ...
  { path: "/vn/guides/weapons/tier-list", changeFrequency: "weekly", priority: 0.78 },
  { path: "/vn/guides/pve-tier-list", changeFrequency: "weekly", priority: 0.78 },
  { path: "/vn/guides/codes", changeFrequency: "daily", priority: 0.72 },
